...
class Club(Base):
    ...
    flex        = Column(String(20),  nullable=True)
    forgiveness_score = Column(Integer, nullable=False, default=50)
    distance_score    = Column(Integer, nullable=False, default=50)
    control_score     = Column(Integer, nullable=False, default=50)
    spin_score        = Column(Integer, nullable=False, default=50)
    launch_type       = Column(String(20), nullable=True)
    target_handicap_min = Column(Integer, nullable=True)
    target_handicap_max = Column(Integer, nullable=True)
